...
#Take a look of first image as array
index = 0
x_train[index]
...
#Add a drop out layer, will set to 50%
...
#Add layer with 10 neurons because we have 10 classifications
...
new_image = plt.imread('./test_images/airplane1.jpeg')
...
#show the sorted labes in order
print(list_index)
